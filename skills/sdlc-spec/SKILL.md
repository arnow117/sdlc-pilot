...
**可选 · 网页划词批注复核**:spec 长/结构复杂(多节多表/跨域契约)、聊天逐条批太累时,可把 spec 渲染成「划词加批注」的本地网页让用户标注,再统一改回——见 `references/web-review/playbook.md`。它只升级"意见怎么喂回来"的机制,不改"批准前不前进"的纪律。默认仍走 text_mode 聊天批(更快);用户说"网页审/划词批注"才用。
